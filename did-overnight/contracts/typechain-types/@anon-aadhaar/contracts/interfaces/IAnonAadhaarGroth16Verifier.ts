...
export interface IAnonAadhaarGroth16VerifierInterface extends Interface {
...
export interface IAnonAadhaarGroth16Verifier extends BaseContract {
  connect(runner?: ContractRunner | null): IAnonAadhaarGroth16Verifier;
  waitForDeployment(): Promise<this>;

  interface: IAnonAadhaarGroth16VerifierInterface;
